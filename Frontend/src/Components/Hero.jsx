  ...
  return (
    <div className="hero container">
      <div className="banner">
        <h1>{title}</h1>
        <h3>WELCOME TO ZEECARE !</h3>
        <p>
          ZeeCare Medical is a state-of-the-art facility dedicated to providing
          ...
          care tailored to each patient's needs. At ZeeCare, we prioritize your
